  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="font-body text-[13px] text-stone mt-0.5">Manage meta tags, structured data, and redirects</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-border p-8 text-center shadow-sm">
        ...
        <p className="font-body text-[14px] text-stone max-w-md mx-auto">
          The SEO Center is being built. You'll be able to manage meta titles, descriptions,
          Open Graph tags, structured data, and 301 redirects from here.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <PlaceholderCard title="Page SEO" description="Edit meta tags for every page" icon={Search} />
        <PlaceholderCard title="Artwork SEO" description="Bulk edit artwork SEO" icon={Search} />
        <PlaceholderCard title="Redirects" description="Manage 301 redirects" icon={Search} />
      </div>
    </div>
  );
}
